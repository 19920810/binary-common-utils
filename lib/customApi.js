...
var CustomApi = function () {
    ...
    try {
      var _loop = function _loop() {
        ...
        _this[type] = function () {
          ...
          _this.handlePromiseForCalls(type, args, requestHandlers, responseHander);
        };
      };
  ...
  _createClass(CustomApi, [{
    ...
    value: function handlePromiseForCalls(type, args, requestHandlers, responseHander) {
      var _this2 = this;
