...
var CustomApi = function (_LiveApi) {
  ...
  function CustomApi() {
    ...
    var overrideOnClose = arguments.length <= 1 || arguments[1] === undefined ? null : arguments[1];
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CustomApi).call(this, option));

    _this.overrideOnClose = overrideOnClose;
    _this.proposalMap = {};
    _this.transformers = {
  ...
  _createClass(CustomApi, [{
    ...
    value: function onClose() {
      ...
      if (this.overrideOnClose) {
        this.overrideOnClose.apply(this, args);
      } else {
        var _get3;

        (_get3 = _get(Object.getPrototypeOf(CustomApi.prototype), 'onClose', this)).call.apply(_get3, [this].concat(args));
      }
    }
  }, {
    key: 'sendRaw',
    value: function sendRaw(json) {
      if ('proposal' in json) {
        ...
        try {
          for (var _iterator2 = Object.keys(this.proposalMap)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      ...
      _get(Object.getPrototypeOf(CustomApi.prototype), 'sendRaw', this).call(this, json);
    }
  }, {
    key: 'destroy',
